  ...
  function TireRevisionController(SELECTED_TIRES,
    ...
    function activate() {
      ...
      if(revision) {
        ...
        vm.selectedTires.rightFrontTireSelectedOption = ITEMS[0].rightFrontTireSelectedOption;
        vm.selectedTires.leftFrontTireSelectedOption = ITEMS[1].leftFrontTireSelectedOption;
        vm.selectedTires.leftBackTireSelectedOption = ITEMS[2].leftBackTireSelectedOption;
        vm.selectedTires.rightBackTireSelectedOption = ITEMS[3].rightBackTireSelectedOption;
        vm.selectedTires.extraTireSelectedOption = ITEMS[4].extraTireSelectedOption;
      }
    }
    activate();
