(function() {
  ...
  function TireRevisionController($state, CarDeliveryInfoFirebaseService, CarInfoFirebaseService) {
    ...
    vm.items = {
      rightFrontTireSelectedOption: {id:'0', name: 'Bridgestone'},
      leftFrontTireSelectedOption: {id:'0', name: 'Bridgestone'},
      leftBackTireSelectedOption: {id:'0', name: 'Bridgestone'},
      rightBackTireSelectedOption: {id:'0', name: 'Bridgestone'}
    };
